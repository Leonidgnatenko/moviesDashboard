...
import com.geeerty.slyjoker.adapter.RecyclerAdapterCasts;
import com.geeerty.slyjoker.api.ApiClient;
import com.geeerty.slyjoker.api.ApiInterface;
import com.geeerty.slyjoker.data.MovieContract;
import com.geeerty.slyjoker.data.MovieDbHelper;
import com.geeerty.slyjoker.model.Casts;
import com.geeerty.slyjoker.model.Review;
import com.geeerty.slyjoker.model.Video;
...
import static com.geeerty.slyjoker.Utils.Constants.ARG_POSITION;
...
public class MoviesDetailsFragment extends Fragment implements View.OnClickListener {
    ...
    ImageView imageView;
    @Nullable
    @BindView(R.id.backButton) ImageView imageViewBack;
